...
export default function TwoImgCenter({
  ...
  return (
    <div className="flex flex-col w-full gap-12 md:max-w-250">
      ...
      <div className="h-[80vw] md:h-[70vw] md:max-h-[651px] md:w-full relative">
        ...
        <div className="object-cover absolute h-[52vw] w-[83vw] top-8/16 -right-1/12 md:top-[min(100%,316px)] md:right-auto md:left-[min(50vw,600px)] md:w-[40vw] md:max-w-[446px] md:h-[30vw] md:max-h-[335px]">
          {images[1]?.image && (
            <ImageMedia
              fill
              imgClassName="object-cover"
