            ...
            <div className="flex flex-col gap-12 w-full md:max-w-250 relative">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex gap-2.5 items-center md:gap-3">
                        ...
                        <IconArrowRight iconClasses={`stroke-z-${accentColor || 'purple'} h-[30px] w-[30px] md:h-[36px] md:w-[36px]`} />
                    </div>
                ...
                <FeatureListBlockClient accentColor={accentColor} blockType="featureList" buttons={buttons} features={features} />
            </div>
        </div>
    );
};
