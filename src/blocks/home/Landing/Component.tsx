...
export const LandingBlock: React.FC<LandingBlockProps> = (props) => {
  ...
  return (
    <div className="flex justify-center items-center px-5 w-full pb-20 sm:pt-30 sm:pb-32 sm:min-h-[80vh] overflow-clip">
      <div className="flex flex-col gap-12 w-full sm:max-w-[1000px] relative">
        <div className="flex flex-col gap-3 sm:grid sm:grid-cols-2 sm:gap-12 z-10 pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0 flex justify-center items-center w-full">
          <Swirl />
        </div>
      </div>
      <Arrow />
