        ...
        <div className="flex justify-center items-center px-5 w-full sm:pt-30 sm:pb-32 sm:min-h-[80vh]">
            <div className='flex flex-col gap-12 w-full sm:max-w-[1000px]'>
                <div className='flex flex-col gap-3 sm:grid sm:grid-cols-2 sm:gap-12'>
                    <h1 className='w-full sm:text-[8vw] lg:text-[5rem]'>
                        {leftTitle}
                    </h1>
            ...
            >
                <svg fill="none" height="69" viewBox="0 0 52 69" width="52" xmlns="http://www.w3.org/2000/svg">
                    <path d="M43 43.1793L40.0037 40.1453L28.125 52.152V8.60693H23.875V52.152L12.0175 40.1238L9 43.1793L26 60.3931L43 43.1793Z" fill="black" />
                </svg>
            </motion.div>
        </div>
    );
