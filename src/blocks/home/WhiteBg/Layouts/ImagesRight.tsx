...
export default function LeftAligned1({
  ...
  return (
    <div className="flex flex-col z-10 gap-10 md:gap-0 md:w-full md:flex-row-reverse md:max-w-[1000px] md:justify-between scale-x-[-1]">
        ...
        <div className="flex flex-col gap-4">
          {
            ...
            <div
              className="group larger-text scale-x-[-1] text-right"
